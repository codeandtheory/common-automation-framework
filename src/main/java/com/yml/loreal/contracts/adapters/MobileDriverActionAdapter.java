package com.yml.loreal.contracts.adapters;

import com.aventstack.extentreports.ExtentTest;
import com.google.inject.Inject;
import com.google.inject.name.Named;
import com.yml.loreal.common.AppUiObjectNames;
...
public abstract class MobileDriverActionAdapter {
    ...
    public WebElement getWebElementByLocator(String locatorStrategy, String locator) {
        ...
        try {
            ...
            e.printStackTrace();
            this.testCase.error("Failed to find the Element with " + locatorStrategy + "  : " + locator);
            this.testCase.error(e);
            element = null;
